...
#ifndef THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_FUNCTIONS_DATE_TIME_UTIL_H_
...
//
// SQL timestamps are unix timestamps (scaled to include fractional
...
//
// Converting between SQL timestamps and strings requires timezone
...
// At the SQL level, the timezone can be embedded in the string or can
...
// The rule is the same as the current SQL date_part.
// For example:
...
// Encode a SQL DATE value using <format>.
