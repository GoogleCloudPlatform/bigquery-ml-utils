...
#ifndef THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_FUNCTIONS_CAST_DATE_TIME_H_
#define THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_FUNCTIONS_CAST_DATE_TIME_H_
...
// if the resulting timestamp is not in the SQL valid range.
//
...
// the resulting date is not in the SQL valid range.
//
// Requires that the string_view arguments are UTF8.
//
// The supported format elements and their semantics are different from those
