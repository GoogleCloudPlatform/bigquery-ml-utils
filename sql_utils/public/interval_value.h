...
#ifndef THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_INTERVAL_VALUE_H_
#define THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_INTERVAL_VALUE_H_
...
class IntervalValue final {
 ...
 public:
  ...
  static absl::StatusOr<IntervalValue> FromMonthsDaysMicros(int64_t months,
                                                            int64_t days,
                                                            int64_t micros) {
    SQL_RETURN_IF_ERROR(ValidateMonths(months));
    SQL_RETURN_IF_ERROR(ValidateDays(days));
    SQL_RETURN_IF_ERROR(ValidateMicros(micros));
  ...
  static absl::StatusOr<IntervalValue> FromMonthsDaysNanos(int64_t months,
    ...
    SQL_RETURN_IF_ERROR(ValidateMonths(months));
    SQL_RETURN_IF_ERROR(ValidateDays(days));
    SQL_RETURN_IF_ERROR(ValidateNanos(nanos));
...
#endif  // THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_INTERVAL_VALUE_H_
