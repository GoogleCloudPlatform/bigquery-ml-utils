...
#ifndef THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_ERROR_HELPERS_H_
#define THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_ERROR_HELPERS_H_
...
// Format an error message.  If this looks like a SQL error, format it as
...
// Return true if <status> has a bigquery_ml_utils::ErrorLocation payload.
bool HasErrorLocation(const absl::Status& status);

// Copy a bigquery_ml_utils::ErrorLocation payload out of <status> into <*location>.
// Return true if <status> had an ErrorLocation.
bool GetErrorLocation(const absl::Status& status, ErrorLocation* location);

// Mutate <*status> by removing any attached bigquery_ml_utils::ErrorLocation payload.
...
#endif  // THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_ERROR_HELPERS_H_
