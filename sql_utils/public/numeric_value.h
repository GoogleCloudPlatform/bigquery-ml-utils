...
#ifndef THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_NUMERIC_VALUE_H_
#define THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_NUMERIC_VALUE_H_
...
#include "sql_utils/common/multiprecision_int.h"
#include "sql_utils/public/numeric_constants.h"
...
// This class represents values of the SQL NUMERIC type. Such values are
...
class NumericValue final {
 public:
  ...
  //
  // This method accepts the same number formats as SQL floating point
  // literals, namely:
...
// This class represents values of the SQL BIGNUMERIC type. Supports 38
...
template <bool round, int N>
  ...
  SQL_DCHECK_EQ(value.number()[N - 1], 0);
...
inline absl::StatusOr<NumericValue> BigNumericValue::ToNumericValue() const {
  ...
  abs_value.DivMod(std::integral_constant<uint64_t, internal::k1e10>(),
                   &abs_value, &remainder);
  SQL_DCHECK_EQ(abs_value.number()[3], 0);
...
#endif  // THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_NUMERIC_VALUE_H_
