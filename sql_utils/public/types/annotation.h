...
#ifndef THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_TYPES_ANNOTATION_H_
#define THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_TYPES_ANNOTATION_H_
...
#include "sql_utils/public/annotation.pb.h"
#include "sql_utils/public/types/simple_value.h"
#include "sql_utils/public/types/type.h"
...
class AnnotationSpec {
 public:
  ...
  // For SQL AnnotationSpecs, the returned ID should be the same as the
...
enum class AnnotationKind {
  // Annotation id for bigquery_ml_utils::CollationAnnotation.
  kCollation = 1,
  // Annotation ID for the SampleAnnotation, which is used for testing
  // purposes only.
  kSampleAnnotation = 2,
  // Annotation ID up to kMaxBuiltinAnnotationKind are reserved for SQL
...
#endif  // THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_TYPES_ANNOTATION_H_
