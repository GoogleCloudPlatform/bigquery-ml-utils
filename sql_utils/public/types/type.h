...
#ifndef THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_TYPES_TYPE_H_
#define THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_TYPES_TYPE_H_
...
// #include "sql_utils/public/types/value_equality_check_options.h"
#include "sql_utils/public/types/value_representations.h"
...
// In-memory representation of a SQL type.
...
class Type {
 public:
  ...
  // Extended types are defined outside of SQL codebase. They have
  // TYPE_EXTENDED type kind and their classes inherit bigquery_ml_utils::ExtendedType
  // class.
  ...
  // Note that this means the SQL type supports equality, but there are
 ...
 protected:
  ...
  struct FormatValueContentOptions {
    ...
    // internal bigquery_ml_utils::Value formatting functions were using these two flags
 ...
 private:
  ...
  // bigquery_ml_utils::Value and bigquery_ml_utils::Type to manage Value objects' content.
  //
  // Caveat: all *ValueContent* functions should be used only by
  // bigquery_ml_utils::Value class, which enforces necessary invariants on their
...
#endif  // THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_PUBLIC_TYPES_TYPE_H_
