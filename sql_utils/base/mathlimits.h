...
#ifndef THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_BASE_MATHLIMITS_H_
#define THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_BASE_MATHLIMITS_H_
...
#define SQL_UNSIGNED_MAX_10_EXP(Type) \
  (sizeof(Type) == 1                      \
       ? 2                                \
       : (sizeof(Type) == 2               \
              ? 4                         \
...
#define SQL_DECL_INT_LIMIT_FUNCS                       \
...
#define SQL_DECL_SIGNED_INT_LIMITS(IntType, UnsignedIntType)  \
  template <>                                                     \
  struct MathLimits<IntType> {                                    \
    ...
    static const Type kPosMax = SQL_SIGNED_INT_MAX(Type);     \
    static const Type kMin = SQL_SIGNED_INT_MIN(Type);        \
    static const Type kMax = kPosMax;                             \
    static const Type kNegMin = -1;                               \
    static const Type kNegMax = kMin;                             \
    static const int kMin10Exp = 0;                               \
    static const int kMax10Exp = SQL_SIGNED_MAX_10_EXP(Type); \
    static const Type kEpsilon = 1;                               \
    static const Type kStdError = 0;                              \
    SQL_DECL_INT_LIMIT_FUNCS                                  \
  };

#define SQL_DECL_UNSIGNED_INT_LIMITS(IntType)                   \
  template <>                                                       \
  struct MathLimits<IntType> {                                      \
    typedef IntType Type;                                           \
    ...
    static const bool kIsInteger = true;                            \
    static const Type kPosMin = 1;                                  \
    static const Type kPosMax = SQL_UNSIGNED_INT_MAX(Type);     \
    static const Type kMin = 0;                                     \
    static const Type kMax = kPosMax;                               \
    static const int kMin10Exp = 0;                                 \
    static const int kMax10Exp = SQL_UNSIGNED_MAX_10_EXP(Type); \
    static const Type kEpsilon = 1;                                 \
    static const Type kStdError = 0;                                \
    SQL_DECL_INT_LIMIT_FUNCS                                    \
  };
...
SQL_DECL_SIGNED_INT_LIMITS(signed char, unsigned char)
// NOLINTNEXTLINE(runtime/int)
SQL_DECL_SIGNED_INT_LIMITS(signed short int, unsigned short int)
// NOLINTNEXTLINE(runtime/int)
SQL_DECL_SIGNED_INT_LIMITS(signed int, unsigned int)
// NOLINTNEXTLINE(runtime/int)
SQL_DECL_SIGNED_INT_LIMITS(signed long int, unsigned long int)
// NOLINTNEXTLINE(runtime/int)
SQL_DECL_SIGNED_INT_LIMITS(signed long long int, unsigned long long int)
// NOLINTNEXTLINE(runtime/int)
SQL_DECL_UNSIGNED_INT_LIMITS(unsigned char)
// NOLINTNEXTLINE(runtime/int)
SQL_DECL_UNSIGNED_INT_LIMITS(unsigned short int)
// NOLINTNEXTLINE(runtime/int)
SQL_DECL_UNSIGNED_INT_LIMITS(unsigned int)
// NOLINTNEXTLINE(runtime/int)
SQL_DECL_UNSIGNED_INT_LIMITS(unsigned long int)
// NOLINTNEXTLINE(runtime/int)
SQL_DECL_UNSIGNED_INT_LIMITS(unsigned long long int)

#undef SQL_DECL_SIGNED_INT_LIMITS
#undef SQL_DECL_UNSIGNED_INT_LIMITS
#undef SQL_SIGNED_INT_MAX
#undef SQL_SIGNED_INT_MIN
#undef SQL_UNSIGNED_INT_MAX
#undef SQL_SIGNED_MAX_10_EXP
#undef SQL_UNSIGNED_MAX_10_EXP
#undef SQL_DECL_INT_LIMIT_FUNCS

// ========================================================================= //
#ifdef WIN32  // Lacks built-in isnan() and isinf()
#define SQL_DECL_FP_LIMIT_FUNCS                                     \
...
#define SQL_DECL_FP_LIMITS(FP_Type, PREFIX)       \
  template <>                                         \
  struct MathLimits<FP_Type> {                        \
    ...
    static const Type kPosInf;                        \
    static const Type kNegInf;                        \
    SQL_DECL_FP_LIMIT_FUNCS                       \
  };

SQL_DECL_FP_LIMITS(float, FLT)
SQL_DECL_FP_LIMITS(double, DBL)
SQL_DECL_FP_LIMITS(long double, LDBL)

#undef SQL_DECL_FP_LIMITS
#undef SQL_DECL_FP_LIMIT_FUNCS

// ========================================================================= //

}  // namespace bigquery_ml_utils_base

#endif  // THIRD_PARTY_PY_BIGQUERY_ML_UTILS_SQL_UTILS_BASE_MATHLIMITS_H_
