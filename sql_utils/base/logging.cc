...
// The SQL_VLOG level, only SQL_VLOG with level equal to or below this
// level is logged.
...
// Sets the verbosity threshold for SQL_VLOG. A SQL_VLOG command with a
// level greater
// than this will be ignored.
//
// level: verbosity threshold for SQL_VLOG to be set. A SQL_VLOG command with
